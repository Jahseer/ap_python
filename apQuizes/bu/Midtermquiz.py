...
answer = "Its is a set of instructions for a computer to use/perform and it basically does what you instruct it to do"
...
# 
anwser=("abstraction means to basically put together and complexitiy is to take apart or remove this ")

examples=("Computer, pc")

# 3. What is Syntax in Python and why is it important to write proper syntax?

answer=(" A syntax is a rules that defines how the code will be written and it is important because we wouldn't know how the code would be written if we didn't have this feature ")

# 4. What is a function, and why do we wrap our code inside of functions?

answer=("A function is a block of code that gives the code instructions to eventually call that code but basically short answer a function makes code to run a specific")
...
answer= ("a varible cannot start with a number,it must start with a letter or underscore and they can only have numeric characters and underscores")
...
answer6= (" the names would print out because you named it name and student this told it to print that and name and student equal to the names so that would print because you instructed it to print the name")
...
answer7=("we use == to see is the value on the left is equal to the right and != is the see if there not equal and = the to print something that is equal to the code that was instructed")
...
answer11= ('parameters are placeholders and arguments are declared when a function is called')
...
answer= ("this means that you might have a used wrong varible or didn't complete the function something wrong or didn't have you code finished")
...
answer14=('when you get this error you didnt indent your code correctly ')
...
while password!='coding_12' and count<3:
    password=input('Enter password: ')

    if password=='coding_12' :
