...
def elevator():
    A = ("boys latin office ")
    B = ("gym")
    G = ("floor dosen't exist")

    floor101=("boys latin office")
    floor203=("gym")

    Print("floor101 + floor203")
...
daytime = int(input("Please enter what part of the day its is : "))
if (daytime = ('10am')and nightime = ('8pm')):
 daytime = True
else:
 nightime = False
...
numbers= [100,230,40,39403,19]

largest_number= 39403
...
answer9='calling a function means to tell your code to runs a set of actions that you told the code to do. we call functions because if we didnt call are code correctly it would print how is suppose to'
...
my_list = ['chicken', 'ice cream' 'string beans']
